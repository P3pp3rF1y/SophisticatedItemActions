...
class ItemTransferHandlerTest {
	...
	@Test
	void combinesRepeatedRecipeInputsBeforeSubtractingInventory() {
	...
	@Test
	void keepsOnlyTheDeficitForFullStackTargets() {
	...
	@Test
	void acceptsAnyTagAlternativeAlreadyInInventory() {
		List<List<ItemStack>> missingIngredients = ItemTransferHandler.getMissingRecipeIngredientOptions(
	...
	@Test
	void removesDuplicateIngredientAlternatives() {
		List<List<ItemStack>> missingIngredients = ItemTransferHandler.getMissingRecipeIngredientOptions(
	...
	@Test
	void reservesAlternativesForMoreConstrainedRecipeInputs() {
		List<List<ItemStack>> missingIngredients = ItemTransferHandler.getMissingRecipeIngredientOptions(
	...
	private static void assertIngredientCount(List<List<ItemStack>> ingredients, net.minecraft.world.item.Item item, int count) {
